...
const Footer = () => {
  const [currentYear, setCurrentYear] = useState(2025); // Default to a fixed year for SSR
    ...
    <footer className="bg-white shadow-inner dark:bg-gray-900">
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <p className="text-gray-600 dark:text-gray-400">
              © {currentYear} Peter&apos;s Portfolio. All rights reserved.
            </p>
          </div>
        ...
        <div className="mt-4 flex justify-center space-x-6">
          ...
          <Link href="/projects" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
            Projects
          </Link>
          <Link href="/achievements" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
            Achievements
          </Link>
