      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <Link to="/" className="px-4 py-2 rounded-lg text-sm font-medium text-gray-300 hover:text-blue-400 hover:bg-gray-700 transition-all duration-200">
              Home
            </Link>
            <Link to="/projects" className="px-4 py-2 rounded-lg text-sm font-medium text-gray-300 hover:text-blue-400 hover:bg-gray-700 transition-all duration-200">
              Projects
            </Link>
            <Link to="/about" className="px-4 py-2 rounded-lg text-sm font-medium text-gray-300 hover:text-blue-400 hover:bg-gray-700 transition-all duration-200">
              About
            </Link>
            ...
            <button
              ...
              className="p-2 rounded-lg text-gray-300 hover:text-blue-400 hover:bg-gray-700 transition-all duration-200"
